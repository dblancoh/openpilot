...
DAYS_NO_CONNECTIVITY_MAX = 10950  # do not allow to engage after about 30 years without internet
DAYS_NO_CONNECTIVITY_PROMPT = 10947  # send an offroad prompt after about 30 years with no internet
